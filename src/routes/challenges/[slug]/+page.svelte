<script lang="ts">
	...
	// Get completion status from challenge metadata
...
<div class="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
	<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
		...
		<!-- Challenge Header Card with Watermark -->
		...
		{#if isUnlocked || isCompleted}
			<!-- Technologies, Learning Outcomes, etc. sections -->
			...
			<!-- Challenge Content with Watermark -->
