						...
						<div>
							...
							<div class="flex flex-wrap gap-2">
								{#each data.challenge.collaborators as collaborator}
									<span class="px-3 py-1.5 rounded-lg text-sm font-semibold bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
										{collaborator}
									</span>
								{/each}
							</div>
