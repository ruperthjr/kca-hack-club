<script lang="ts">
	...
	// Extend PageData with specific properties used in the template
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
	<div class="mb-8">
		<a href="/challenges/weekly" class="text-primary-600 dark:text-primary-400 hover:underline mb-4 inline-block">
		...
		<div class="card">
			<div class="p-8">
				<div class="flex items-center space-x-2 mb-4">
					<span class="badge badge-primary">Week {data.weekNumber}</span>
